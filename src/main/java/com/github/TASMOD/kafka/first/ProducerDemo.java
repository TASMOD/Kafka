...
public class ProducerDemo {
    ...
    public static void main(String[] args) {
        ...
        /* Old way
        //Properties can be found at kafka documentation
        ...
        */
        ...
        final KafkaProducer<String, String> producer = new KafkaProducer<String,
                String>(properties);
        // create a producer record. Topic is auto generated
        // it's not hard coded (it appears magically don't be afraid!)
